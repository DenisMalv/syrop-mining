    ...
    return (
        <div>
            ...
            >
                    <div className="info pt-6 mr-15">
                        ...
                        <ul className="custom-list custom-list-row">
                            ...
                            <li className="custom-list--item mb-6">
                                ...
                                <div className="info2 style--info border-right pr-20">
                                    3059
                                </div>
                            </li>
                            <li className="custom-list--item mb-6">
                                <span className="info1 style--info">Age:</span>
                                <div className="info2 style--info">
                                    21 min.
                                </div>
                            </li>
                            <li className="custom-list--item mb-6">
                                <span className="info1 style--info">Remaining:</span>
                                <div className="info2 style--info">
                                    <span className="color--success">1 mon, 4 d</span>
                                </div>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div className="dbl-btns dbl-btns--10 ">
                            ...
                            <a href="#" className="btn btn-widget btn-widget--34 btn--bordered-2 r-2 mb-6">
                                <span className="ico">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M16.66 10.0267C16.6533 11.7242 16.0091 13.4192 14.7141 14.7142C12.1108 17.3175 7.88913 17.3175 5.28579 14.7142C4.82246 14.2508 4.44579 13.735 4.14746 13.1883"
                                            stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"></path>
                                        <path
                                            d="M3.33643 9.89168C3.36309 8.22168 4.01143 6.56001 5.28559 5.28584C7.88893 2.68251 12.1106 2.68251 14.7139 5.28584C15.1773 5.74918 15.5539 6.26501 15.8523 6.81168"
                                            stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"></path>
                            ...
                            <a href="#" className="btn btn-widget btn-widget--34 btn--bordered r-2 mb-6">
                                <span className="ico">
                                    { +accordionItemData.value % 2 !== 0 && <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <button
                                className="btn btn-primary btn--md mb-6 nowrap fw-500 text"
                                data-modal="#modal-1"
                                onClick={() => setIsConnectShown(true)}
                            >Connect</button>
                            <a href="#" className="btn btn-widget btn-widget--34 btn--bordered-2 r-2 mb-6">
                                <span className="ico">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7.3335 7.33334L14.6668 14.6667" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"></path>
                                        <path d="M14.6668 7.33334L7.3335 14.6667" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"></path>
                                    </svg>
                                </span>
                            </a>
                        </div>
                ...
                FooterRender={() => (<div className="dropdown-footer border-top px-14">
                        ...
                        <div className="col-12">
                            <ul className="custom-list custom-list-row mt-15">
                                ...
                                <li className="custom-list--item">
                                    ...
                                    <div className="info2 style--info mb-15">
                                        Successfully loaded <a href="#" className="default--link fw-500">
